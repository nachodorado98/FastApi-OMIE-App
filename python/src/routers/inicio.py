...
async def inicio()->Dict:
	...
	return {"mensaje": "¡Bienvenido a la REST API de OMIE Data con FastAPI!",
			"version": "1.0.0",
			"descripcion": "Esta API permite realizar operaciones con los datos del mercado electrico de OMIE. Todos los datos del mercado electrico se guardan en una base de datos PostgreSQL.",
			"documentacion": "/docs"}
